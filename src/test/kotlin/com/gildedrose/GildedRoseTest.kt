...
internal class GildedRoseTest {
    ...
    fun testQualityDecreaseForBasicItem() {
        val items = arrayOf<ItemWrapper>(ItemWrapper.BasicItem(Item("foo", 5, 5)))
    ...
    fun testQualityNeverDropBelow0() {
        val items = arrayOf<ItemWrapper>(ItemWrapper.BasicItem(Item("foo", 5, 0)))
        val app = GildedRose(items)
        app.updateQuality()
    ...
    fun testQualityDecreaseTwiceAsFastForBasicItemWhenSellInPassed() {
        val items = arrayOf<ItemWrapper>(ItemWrapper.BasicItem(Item("foo", 0, 4)))
        val app = GildedRose(items)
        app.updateQuality()
    ...
    fun testQualityIncreaseForEnhancedItem() {
        val items = arrayOf<ItemWrapper>(ItemWrapper.EnhancedItem(Item("Aged Brie", 1, 5)))
        val app = GildedRose(items)
        app.updateQuality()
    ...
    fun testQualityIncreaseTwiceAsFastForEnhancedItemWhenSellInPassed() {
        val items = arrayOf<ItemWrapper>(ItemWrapper.EnhancedItem(Item("Aged Brie", 0, 5)))
        val app = GildedRose(items)
        app.updateQuality()
    ...
    fun testQualityNeverIncreaseAbove50() {
        val items = arrayOf<ItemWrapper>(ItemWrapper.EnhancedItem(Item("Aged Brie", 2, 50)))
        val app = GildedRose(items)
        app.updateQuality()
    ...
    fun testQualityAndSellInNeverDecreaseForLegendaryItem() {
        val items = arrayOf<ItemWrapper>(ItemWrapper.LegendaryItem(
    ...
    fun testQualityIncreaseForBackstageItemWhenMoreThan10Days() {
        val items = arrayOf<ItemWrapper>(ItemWrapper.BackstageItem(
